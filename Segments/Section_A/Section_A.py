...
bass_1_note = [11, ]
bass_2_note = [9, ]
contrabass_note = [-3, -2, 2, 7, -2, 2, -3, 7, 2, -3, -2]
...
voice_2_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(14, 4), (15, 4), soprano_one_musicmaker_three],
...
voice_3_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (4, 4), soprano_two_musicmaker_one],
        [(7, 4), (9, 4), soprano_two_musicmaker_two],
        [(10, 4), (12, 4), soprano_two_musicmaker_three],
        [(12, 4), (16, 4), soprano_two_musicmaker_one],
        [(21, 4), (23, 4), soprano_two_musicmaker_two],
        [(23, 4), (25, 4), soprano_two_musicmaker_three],
    ]
])
...
voice_4_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(12, 4), (16, 4), soprano_three_musicmaker_three],
        [(16, 4), (17, 4), soprano_three_musicmaker_one],
        [(21, 4), (23, 4), soprano_three_musicmaker_two],
        [(23, 4), (24, 4), soprano_three_musicmaker_three],
...
voice_5_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (2, 4), alto_one_musicmaker_one],
        [(3, 4), (5, 4), alto_one_musicmaker_two],
        [(5, 4), (9, 4), alto_one_musicmaker_three],
        [(14, 4), (16, 4), alto_one_musicmaker_one],
        [(16, 4), (18, 4), alto_one_musicmaker_two],
        [(21, 4), (23, 4), alto_one_musicmaker_three],
        [(24, 4), (27, 4), alto_one_musicmaker_one],
    ]
])
...
voice_6_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (1, 4), alto_two_musicmaker_one],
...
voice_7_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(11, 4), (12, 4), alto_three_musicmaker_three],
        [(12, 4), (15, 4), alto_three_musicmaker_one],
        [(18, 4), (19, 4), alto_three_musicmaker_two],
        [(19, 4), (20, 4), alto_three_musicmaker_three],
        [(21, 4), (23, 4), alto_three_musicmaker_one],
...
voice_8_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (5, 4), alto_four_musicmaker_one],
        [(9, 4), (12, 4), alto_four_musicmaker_two],
        [(14, 4), (15, 4), alto_four_musicmaker_three],
        [(21, 4), (23, 4), alto_four_musicmaker_one],
        [(23, 4), (26, 4), alto_four_musicmaker_two],
    ]
])
...
voice_9_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(7, 4), (9, 4), alto_five_musicmaker_two],
        [(10, 4), (12, 4), alto_five_musicmaker_three],
        [(12, 4), (16, 4), alto_five_musicmaker_one],
        [(21, 4), (23, 4), alto_five_musicmaker_two],
        [(23, 4), (25, 4), alto_five_musicmaker_three],
    ]
])
...
voice_10_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(12, 4), (16, 4), tenor_one_musicmaker_three],
        [(16, 4), (17, 4), tenor_one_musicmaker_one],
        [(21, 4), (23, 4), tenor_one_musicmaker_two],
        [(23, 4), (24, 4), tenor_one_musicmaker_three],
...
voice_11_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (2, 4), tenor_two_musicmaker_one],
        [(3, 4), (5, 4), tenor_two_musicmaker_two],
        [(5, 4), (9, 4), tenor_two_musicmaker_three],
        [(14, 4), (16, 4), tenor_two_musicmaker_one],
        [(16, 4), (18, 4), tenor_two_musicmaker_two],
        [(21, 4), (23, 4), tenor_two_musicmaker_three],
...
voice_12_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(7, 4), (9, 4), tenor_three_musicmaker_one],
        [(9, 4), (12, 4), tenor_three_musicmaker_one],
        [(16, 4), (19, 4), tenor_three_musicmaker_one],
        [(21, 4), (22, 4), tenor_three_musicmaker_one],
    ]
])
...
voice_13_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (5, 4), tenor_four_musicmaker_one],
        [(5, 4), (6, 4), tenor_four_musicmaker_two],
        [(11, 4), (12, 4), tenor_four_musicmaker_three],
        [(12, 4), (15, 4), tenor_four_musicmaker_one],
        [(18, 4), (19, 4), tenor_four_musicmaker_two],
        [(19, 4), (20, 4), tenor_four_musicmaker_three],
        [(21, 4), (23, 4), tenor_four_musicmaker_one],
        [(23, 4), (27, 4), tenor_four_musicmaker_two],
    ]
])
...
voice_14_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (5, 4), baritone_one_musicmaker_one],
        [(9, 4), (12, 4), baritone_one_musicmaker_two],
        [(14, 4), (15, 4), baritone_one_musicmaker_three],
        [(21, 4), (23, 4), baritone_one_musicmaker_one],
        [(23, 4), (26, 4), baritone_one_musicmaker_two],
    ]
])
...
voice_15_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(10, 4), (12, 4), baritone_two_musicmaker_three],
        [(12, 4), (16, 4), baritone_two_musicmaker_one],
        [(21, 4), (23, 4), baritone_two_musicmaker_two],
        [(23, 4), (25, 4), baritone_two_musicmaker_three],
    ]
])
...
voice_16_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (3, 4), baritone_three_musicmaker_one],
        [(5, 4), (6, 4), baritone_three_musicmaker_two],
        [(12, 4), (16, 4), baritone_three_musicmaker_three],
        [(16, 4), (17, 4), baritone_three_musicmaker_one],
        [(21, 4), (23, 4), baritone_three_musicmaker_two],
        [(23, 4), (24, 4), baritone_three_musicmaker_three],
...
voice_17_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(3, 4), (5, 4), bass_one_musicmaker_two],
        [(5, 4), (9, 4), bass_one_musicmaker_three],
        [(14, 4), (16, 4), bass_one_musicmaker_one],
        [(16, 4), (18, 4), bass_one_musicmaker_two],
        [(21, 4), (23, 4), bass_one_musicmaker_three],
...
voice_18_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(7, 4), (9, 4), bass_two_musicmaker_one],
        [(9, 4), (12, 4), bass_two_musicmaker_one],
        [(16, 4), (19, 4), bass_two_musicmaker_one],
        [(21, 4), (22, 4), bass_two_musicmaker_one],
    ]
])
...
voice_19_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        [(0, 4), (5, 4), contrabass_musicmaker_one],
        [(5, 4), (6, 4), contrabass_musicmaker_two],
        [(11, 4), (12, 4), contrabass_musicmaker_three],
        [(12, 4), (15, 4), contrabass_musicmaker_one],
        [(18, 4), (19, 4), contrabass_musicmaker_two],
        [(19, 4), (20, 4), contrabass_musicmaker_three],
        [(21, 4), (23, 4), contrabass_musicmaker_one],
        [(23, 4), (27, 4), contrabass_musicmaker_two],
    ]
])
