...
voice_10_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(114, 8), (116, 8), alto_six_musicmaker_two],
        ...
        [(199, 8), (200, 8), alto_six_musicmaker_two],
    ]
])
...
voice_14_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(199, 8), (200, 8), tenor_four_musicmaker_two],
    ]
])
...
voice_15_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(26, 8), (28, 8), tenor_five_musicmaker_two],
        ...
        [(64, 8), (66, 8), tenor_five_musicmaker_two],
        ...
        [(128, 8), (130, 8), tenor_five_musicmaker_two],
        [(130, 8), (132, 8), tenor_five_musicmaker_two],
...
voice_20_timespan_list = abjad.TimespanList([
    ...
    for start_offset, stop_offset, music_maker in [
        ...
        [(164, 8), (168, 8), bass_two_musicmaker_two],
...
directory = '/Users/evansdsg2/Scores/guerrero/Segments/Section_F'
pdf_path = f'{directory}/Section_F.pdf'
path = pathlib.Path('Section_F.pdf')
if path.exists():
...
score_lines = open('/Users/evansdsg2/Scores/guerrero/Segments/Section_F/Section_F.ly').readlines()
open('/Users/evansdsg2/Scores/guerrero/Build/Section_F.ly', 'w').writelines(score_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 1']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/1.)sopranino/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/1.)sopranino/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 2']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/2.)soprano1/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/2.)soprano1/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 3']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/3.)soprano2/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/3.)soprano2/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 4']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/4.)soprano3/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/4.)soprano3/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 5']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/5.)alto1/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/5.)alto1/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 6']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/6.)alto2/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/6.)alto2/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 7']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/7.)alto3/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/7.)alto3/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 8']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/8.)alto4/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/8.)alto4/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 9']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/9.)alto5/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/9.)alto5/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 10']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/10.)alto6/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/10.)alto6/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 11']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/11.)tenor1/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/11.)tenor1/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 12']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/12.)tenor2/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/12.)tenor2/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 13']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/13.)tenor3/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/13.)tenor3/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 14']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/14.)tenor4/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/14.)tenor4/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 15']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/15.)tenor5/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/15.)tenor5/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 16']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/16.)baritone1/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/16.)baritone1/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 17']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/17.)baritone2/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/17.)baritone2/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 18']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/18.)baritone3/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/18.)baritone3/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 19']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/19.)bass1/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/19.)bass1/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 20']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/20.)bass2/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/20.)bass2/Section_F.ly', 'w').writelines(part_lines[15:-1])
...
for staff in abjad.iterate(score['Staff 21']).components(abjad.Staff):
    ...
    if path.exists():
        print(f'Opening {pdf_path} ...')
        os.system(f'open {pdf_path}')
    part_lines = open('/Users/evansdsg2/Scores/guerrero/Build/parts/21.)contrabass/Section_F.ly').readlines()
    open('/Users/evansdsg2/Scores/guerrero/Build/parts/21.)contrabass/Section_F.ly', 'w').writelines(part_lines[15:-1])
