...
rmaker_one = abjadext.rmakers.stack(
    abjadext.rmakers.talea(
        [11, 8, 12, 7, 10, 9], 16, extra_counts=[0, -1, 0, 0, 1, -1, 1]
    ),
    abjadext.rmakers.force_rest(lambda _: abjad.Selection(_).tuplets().get([7], 17)),
    abjadext.rmakers.force_rest(lambda _: abjad.Selection(_).logical_ties(pitched=True).get([8], 11)),
...
rmaker_two = abjadext.rmakers.stack(
    ...
    abjadext.rmakers.force_rest(lambda _: abjad.Selection(_).logical_ties(pitched=True).get([2], 7)),
    abjadext.rmakers.extract_trivial(lambda _: abjad.Selection(_).tuplets()),
    abjadext.rmakers.rewrite_rest_filled(lambda _: abjad.Selection(_).tuplets()),
    abjadext.rmakers.rewrite_sustained(lambda _: abjad.Selection(_).tuplets()),
)
...
markup = abjad.Markup(r"\markup \bold { F }",  )
