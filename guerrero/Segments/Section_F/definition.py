...
rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[11, 8, 12, 7, 10, 9], denominator=16),
    ...
    #     ),
    logical_tie_masks=[abjadext.rmakers.silence([8], 11)],
    division_masks=[abjadext.rmakers.SilenceMask(pattern=abjad.index([7], 17))],
