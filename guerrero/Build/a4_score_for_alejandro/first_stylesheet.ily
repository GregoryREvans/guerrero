...
\version "2.19.82"
\language "english"
#(set-default-paper-size "a2portrait")
...
\header {
	tagline = ##f
	breakbefore = ##t
	dedication = \markup \override #'(font-name . "Didot") \fontsize #4.5 \center-column {"t  o     t  h  e     F  r  o  s  t     S  a  x  o  p  h  o  n  e    E  n  s  e  m  b  list_  e"}
...
\layout {
	...
	\context {
        ...
        \override VerticalAxisGroup.default-staff-staff-spacing = #'((basic-distance . 0) (minimum-distance . 13) (padding . 5) (stretchability . 0))
    }
    \context {
        \Score
